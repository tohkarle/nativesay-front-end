    ...
    try {
      if (emailRef.current && firstNameRef.current && lastNameRef.current) {
        ...
        if (response.status === 200) {
          enqueueSnackbar("User already exists in the mailing list.", {
            variant: "error",
          });
        } else {
  ...
  return (
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
      ...
      >
        ...
        >
          Don&apos;t miss your chance to be among the first to experience
          NativeSay and provide valuable feedback before it&apos;s officially
          launched.
          <br />
          <br />
      ...
      {isDialogOpen && (
        <PreLaunchThankYou open={isDialogOpen} setOpen={setIsDialogOpen} />
      )}
    </FormProvider>
  );
}
